...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_COLEMAK] = LAYOUT_4x11(
		...
		KC_Z, KC_X , KC_C , KC_V , KC_B, KC_LPRN, KC_K, KC_M , COMMA, KC_DOT, KC_SLSH, 
				L_ESC, L_SPC,   L_ENT, 	 KC_RPRN,       KC_BSPC
		),

	[_NAV] = LAYOUT_4x11(
		KC_TRNS, RESET  , KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP, KC_HOME, KC_UP  , KC_END , KC_TRNS, 
		KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_TRNS, KC_TRNS, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS, 
	...
	[_GAME] = LAYOUT_4x11(
		KC_Q, KC_W 		 , KC_F       , KC_P       , KC_G, KC_RBRC, KC_J, KC_L 		 , KC_U 	  , KC_Y       , KC_SCLN, 
		KC_A, ALT_T(KC_R), CTL_T(KC_S), SFT_T(KC_T), KC_D, KC_LBRC, KC_H, SFT_T(KC_N), CTL_T(KC_E), ALT_T(KC_I), KC_O   , 
		KC_Z, KC_X 		 , KC_C 	  , KC_V       , KC_B, KC_LPRN, KC_K, KC_M 	   	 , KC_COMM    , KC_DOT     , KC_SLSH, 
		    LT(1, KC_ESC), LT(2, KC_SPC),   LT(3, KC_ENT), KC_RPRN,       KC_BSPC)
};

...
//    ┌─────┬─────────┬───┬───┬─────┬──────┐               ┌──────┬──────┬──────┬──────┬──────┐
//    │  `  │ QK_LEAD │ 7 │ 8 │  9  │ mply │               │ pgup │ home │  up  │ end  │ del  │
//    ├─────┼─────────┼───┼───┼─────┼──────┤               ├──────┼──────┼──────┼──────┼──────┤
//    │     │    0    │ 4 │ 5 │  6  │ volu │               │ pgdn │ left │ down │ rght │ bspc │
//    ├─────┼─────────┼───┼───┼─────┼──────┤               ├──────┼──────┼──────┼──────┼──────┤
//    │     │         │ 1 │ 2 │  3  │      │               │ pscr │ ins  │      │      │      │
//    └─────┴─────────┴───┴───┼─────┼──────┼─────┐   ┌─────┼──────┼──────┼──────┴──────┴──────┘
//                            │     │      │     │   │     │      │      │
//                            └─────┴──────┴─────┘   └─────┴──────┴──────┘
  KC_GRAVE , QK_GESC , KC_7 , KC_8 , KC_9    , _______ ,                         KC_PGUP , KC_HOME   , KC_UP   , KC_END   , KC_DEL ,
  _______  , KC_0    , KC_4 , KC_5 , KC_6    , QK_LEAD ,                         KC_PGDN , KC_LEFT   , KC_DOWN , KC_RIGHT , KC_BSPC,
  _______  , _______ , KC_1 , KC_2 , KC_3    , _______ ,                         KC_PSCR , KC_SCLN , KC_INSERT , _______  , _______,
...
//                                              │     │     │ bspc │   │ del │     │     │
//                                              └─────┴─────┴──────┘   └─────┴─────┴─────┘
  _______ , KC_EXLM       , KC_AT         , KC_HASH , KC_DLR  , KC_PERC ,                        KC_CIRC , KC_AMPR , KC_ASTR , KC_EQL  , KC_DEL ,
...
//    ┌─────┬─────┬──────┬──────┬──────┬─────┐                       ┌─────┬─────┬────┬────┬──────┐
//    │     │ spc │ btn1 │ ms_u │ btn2 │ f12 │                       │ f6  │ f7  │ f8 │ f9 │ bspc │
//    ├─────┼─────┼──────┼──────┼──────┼─────┤                       ├─────┼─────┼────┼────┼──────┤
//    │     │  0  │ ms_l │ ms_d │ ms_r │ f11 │                       │ f1  │ f2  │ f3 │ f4 │  f5  │
//    ├─────┼─────┼──────┼──────┼──────┼─────┤                       ├─────┼─────┼────┼────┼──────┤
//    │     │  +  │  1   │  2   │  3   │ f10 │                       │ f12 │  =  │ ,  │ .  │  -   │
//    └─────┴─────┴──────┴──────┼──────┼─────┼─────────┐   ┌─────────┼─────┼─────┼────┴────┴──────┘
//                              │      │ spc │ QK_BOOT │   │ QK_BOOT │     │     │
//                              └──────┴─────┴─────────┘   └─────────┴─────┴─────┘
  _______ , KC_WH_U  , KC_MS_BTN1 , KC_MS_U , KC_MS_BTN2 , KC_F12 ,                         KC_F6   , KC_F7   , KC_F8   , KC_F9  , KC_BSPC,
  _______ , KC_WH_D    , KC_MS_L    , KC_MS_D , KC_MS_R    , KC_F11 ,                         KC_F1   , KC_F2   , KC_F3   , KC_F4  , KC_F5  ,
  _______ , _______ , _______       , OSM(MOD_LCTL)    , OSM(MOD_LCTL)       , KC_F10 ,                         KC_F12  , KC_EQL  , KC_COMM , KC_DOT , KC_MINS,

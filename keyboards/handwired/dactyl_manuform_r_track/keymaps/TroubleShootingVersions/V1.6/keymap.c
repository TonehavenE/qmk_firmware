...
KC_LCTL  , KC_Z ,   KC_X , KC_C    , KC_V         , KC_B   ,               KC_K    ,    KC_M , KC_COMM   , KC_DOT    , KC_SLASH    , KC_QUOTE     ,
                           KC_LBRC,KC_RBRC,                                         _______, KC_LGUI,
                                       LT(_UNICODE, KC_TAB),    LT(_LOWER, KC_SPACE),          _______, LT(_RAISE, KC_BSPC),
                                       LT(_MATH, KC_EQUAL) ,    KC_END    ,          _______, KC_ENT,
...
[_RAISE] = LAYOUT_5x6(
RESET  , _______ , _______ , _______ , _______ , _______,                 _______, KC_DELETE, _______ ,KC_PGUP, _______, _______,

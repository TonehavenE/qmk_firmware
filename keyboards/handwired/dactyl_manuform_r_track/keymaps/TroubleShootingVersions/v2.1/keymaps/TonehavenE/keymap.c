...
/* UNICODE STUFF; CURRENTLY DEBUNK */ 
...
KC_LCTL  , KC_Z ,   KC_X , KC_C    , KC_V         , KC_B   ,               KC_K    ,    KC_M , KC_COMM   , KC_DOT    , KC_SLASH    , KC_QUOTE     ,
                           KC_LBRACKET, KC_RBRACKET,                                      TG(QWERTY), TG(MOUSE),
                                  ...
                                  KC_BSLASH          , KC_MINUS                ,           KC_DELETE, KC_HOME
),
...
KC_LCTL, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                              KC_N  , KC_M  , KC_COMM,KC_DOT ,KC_SLSH,KC_BSLASH,
                      KC_LBRC,KC_RBRC,                                                _______, KC_EQL,
                                  ...
                                  LT(MATH, KC_EQUAL) , KC_END                  ,           _______  , KC_ENTER,
                                  KC_LALT            , KC_MINUS                ,           KC_DELETE, KC_HOME
),
...
[MATH] = LAYOUT_5x6(
KC_RST , _______ , _______ , _______ , _______ , _______,                 _______     , _______  , KC_ASTR, KC_MINUS, KC_PLUS , KC_Z    ,
_______, _______ , _______ , _______ , _______ , _______,                 _______     , KC_7     , KC_8   , KC_9    , KC_EQUAL, KC_Y    ,
_______, KC_LGUI , KC_LALT , KC_LCTL , KC_LSFT , _______,                 _______     , KC_4     , KC_5   , KC_6    , KC_DOT  , KC_X    ,
...
// Unicode layer; currently testing without
/* [UNICODE] = LAYOUT_5x6(

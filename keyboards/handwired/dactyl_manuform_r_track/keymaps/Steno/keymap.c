...
KC_LCTL         , KC_Z ,   KC_X , KC_C, KC_V         , KC_B   ,               KC_K    ,    KC_M        , KC_COMM   , KC_DOT    , KC_SLASH    , LGUI_T(KC_MINUS),
                           KC_LBRC,KC_RBRC,                                         TG(_ADJUST), TG(_STENO),
...
[_STENO] = LAYOUT_5x6(
_x_, STN_N1 , STN_N2, STN_N3, STN_N4, STN_N5 ,                 STN_N6 , STN_N7, STN_N8, STN_N9, STN_NA, STN_NB,
_x_, STN_S1 , STN_TL, STN_PL, STN_HL, STN_ST1,                 STN_ST3, STN_FR, STN_PR, STN_LR, STN_TR, STN_DR,
_x_, STN_S2 , STN_KL, STN_WL, STN_RL, STN_ST2,                 STN_ST4, STN_RR, STN_BR, STN_GR, STN_SR, STN_ZR,
_x_, _x_    , _x_   , _x_   , _x_   , _x_    ,                     _x_,    _x_,    _x_,    _x_,    _x_,    _x_,
                             _x_,_x_,                                    _x_,_x_,
                                        STN_A, STN_O,             _______,    _x_,
                                        _x_  ,   _x_,             _______, STN_E,
                                        _x_  ,   _x_,             _x_    , STN_U
)

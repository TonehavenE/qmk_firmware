...
KC_LSHIFT, KC_A ,   KC_R   , KC_S    , LSFT_T(KC_T) , KC_D   ,               KC_H    ,    LSFT_T(KC_N) , KC_E      , KC_I      , KC_O        , KC_RSHIFT,
KC_LCTRL , KC_Z ,   KC_X   , KC_C    , KC_V         , KC_B   ,               KC_K    ,    KC_M         , KC_COMM   , KC_DOT    , KC_SLASH    , KC_QUOTE ,
                           KC_LBRACKET, KC_RBRACKET,                                      TG(QWERTY), TG(MOUSE),
                                  LT(UNICODE, KC_TAB), LT(NAVIGATION, KC_SPACE),           _______  , KC_HOME,
                                  LT(MATH, KC_EQUAL) , KC_END                  ,           _______  , KC_BSPC,
                                  KC_BSLASH          , X(Dash)                 ,           KC_DELETE, KC_ENTER
),
...
KC_LCTL, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                              KC_N  , KC_M  , KC_COMM,KC_DOT ,KC_SLSH,KC_BSLASH,
                      KC_LBRC,KC_RBRC,                                                TG(QWERTY), KC_EQL,
                                  LT(UNICODE, KC_TAB), LT(NAVIGATION, KC_SPACE),           _______  , KC_HOME,
                                  LT(MATH, KC_EQUAL)    , KC_END                  ,           _______  , KC_BSPC,
                                  KC_BSLASH          , X(Dash)                 ,           KC_DELETE, KC_ENTER
),
...
_______, _______ , _______ , _______ , _______ , _______,                 _______, KC_DELETE, _______ ,KC_PGUP, _______, _______,
...
[_MATH] = LAYOUT_5x6(
_______, _______ , _______ , _______ , _______ , _______,                 X(SQRT)     , X(Divide), KC_ASTR, KC_MINUS, KC_PLUS , KC_Z    ,
...
_______, _______ , _______ , _______ , _______ , _______,                 X(Alpha), X(SQRT)        , X(CubeRoot) , X(FourthRoot)  , X(Angle)      , X(Integral),

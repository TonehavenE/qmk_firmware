...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_RAISE] = LAYOUT_ortho_5x12(
        KC_GRAVE, _______,    _______,  KC_0   ,  _______,  RESET  ,        RESET  ,  KC_DEL ,  _______,  _______  ,  _______  , _______,
    ...
    [_FUNC] = LAYOUT_ortho_5x12(
        ...
        _______ , KC_LGUI,    KC_F4  ,  KC_F5  ,  KC_F6  ,  _______,        _______,  KC_RSFT,  KC_RCTL,  KC_RALT,  KC_LGUI, _______,
